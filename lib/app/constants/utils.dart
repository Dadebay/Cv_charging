...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'tm': {
          'text1': 'Hoş geldiňiz',
          'text2': 'Ulanyjy maglumatlaryny doly we dogry şekilde dolduruň',
          'text3': 'Gmail',
          'text4': 'Açar söz',
          'text5': 'Ulgama gir',
          'text6': 'Hasaba al',
          'text7': 'Ulanyjy ady',
          'text8': 'Ulanyjy familýasy',
          'error1': 'Ulanyjy tapylmady',
          'error2': 'Ýalňyş',
          'error4': 'Dowam edýän zarýadyňyz ýok',
          'error5': 'Şu wagt reserw edip bilmeýäňiz',
          'error3': 'Açar söz ýalňyş',
          'startCharge2': 'Zarýad bermek ',
          'stationsClosest': 'Iň ýakyn stansiýalar ',
          'chargeHistory': 'Zarýad taryhy ',
          'favStations': 'Halan stansiýalarym ',
          'invoicesAndPayments': 'Hasap-faktura we tölegler ',
          'myUsers': 'Ulanyjylarym',
          'cards': 'Kartlarym',
          'myAccount': 'Hasabym',
          'sendOtp': 'Barlag koduny iber',
          'changePhoneNumber': 'Telefon belgisini üýtgediň',
          'changePassword': 'Paroly üýtgetmek',
          'passivateContract': 'Passiw şertnama',
          'deleteContract': 'Şertnamany poz',
          'contractType': 'Şertnamanyň görnüşi',
          'personal': 'Şahsy',
          'contractCode': 'Şertnama kody',
          'contactUsSubtitle': 'Aşakdaky \n maglumat arkaly biziň bilen habarlaşyp bilersiňiz:',
          'withQRCode': 'QR kody bilen',
          'or': 'ýa-da',
          'ongoingCharges': 'Dowam edýän zarýadlar',
          'enterStationCode': 'Stansiýa koduny girizmek',
          'enterCode': 'Kod giriz',
          'startCharge': 'Başlady',
          'startChargeSub': 'Ulagyňyz zarýda almana başlady',
          'requests': 'Islegler',
          'type': 'Görnüşi',
          'cardID': 'Kart ID',
          'status': 'Ýagdaýy',
          'active': 'Aktiw',
          'requestDate': 'Talap senesi',
          'requestBy': 'Kimden',
          'notActive': 'Aktiw däl',
          'activateCard': 'Aktiw kart goş',
          'requestCard': 'Kart sora',
          'createNewUser': 'Täze ulanyjy dörediň',
          'makePayment': 'Töleg ediň',
          'filterStations': 'Filter stansiýalary',
          'favorites': 'Halanlarym',
          'public': 'Hemmeler üçin açyk',
          'limited': 'Çäkli ulanylyş',
          'onlyCV': 'Diňe Cv zarýad berýän ulag stansiýalary',
          'cFee': 'Sagatlyk töleg',
          'bFee': 'Blok tölegi',
          'oFee': 'Töleg',
          'direction': 'Salgy',
          ...
          'friday': 'Anna',
          'saturday': 'Şenbe',
          'atoUse': 'Ulanmak üçin elýeterli',
          'reserve': 'Rezerwe',
          'mInfo': 'Has giňişleýin maglumat',
          'operator': 'Operator',
          'location': 'Salgy',
          'addtoFav': 'Halanlarym goş',
          'setAsHome': 'Öý stansiýasy hökmünde belle',
          'setAsWork': 'Iş stansiýasy hökmünde bellen',
          'uType': 'Ulanyş görnüşi',
          'address': 'Salgysy',
          'sHours': 'Işleýän sagatlary',
          'stationName': 'Stansiya ady',
          'stationCount': 'Stansiýa sany',
          'edit': 'Düzetmek',
          'delete': 'Pozmak',
          'addStation': 'Goşmak',
        ...
        'ru': {
          ...
          'text2': 'Полное и правильное заполнение информации о пользователе',
          'text3': 'Gmail',
          'text4': 'Пароль',
          'text5': 'Войти',
          'text6': 'Зарегистрироваться',
          'text7': 'Имя пользователя',
          'text8': 'Фамилия',
          'error1': 'Пользователь не найден',
          'error2': 'Неправильный',
          'error4': 'У вас сейчас нет доступных электрических зарядов',
          'error5': 'Вы не можете сделать бронирование в это время',
          'error3': 'Неверный пароль',
          'startCharge2': 'Дайте зарядку электричеству ',
          'stationsClosest': 'Ближайшие станции ',
          'chargeHistory': 'История начислений ',
          'favStations': 'Любимые станции ',
          'invoicesAndPayments': 'Счета и платежи ',
          'myUsers': 'Мои пользователи',
          'cards': 'Карты',
          'myAccount': 'Мой счет',
          'sendOtp': 'Отправьте код подтверждения',
          'changePhoneNumber': 'Изменить номер телефона',
          'changePassword': 'Изменить пароль',
          'passivateContract': 'Пассивный контракт',
          'deleteContract': 'Удалить контракт',
          'contractType': 'Вид контракта',
          'personal': 'Личный',
          'contractCode': 'Код контракта',
          'contactUsSubtitle': 'Вы можете связаться с нами, используя следующую \n информацию:',
          'withQRCode': 'с QR-кодом',
          'or': 'или',
          'ongoingCharges': 'Непрерывные электрические заряды',
          'enterStationCode': 'Введите код станции',
          'enterCode': 'ввод кода',
          'startCharge': 'Началось',
          'startChargeSub': 'Ваш автомобиль начал заряжаться',
          'requests': 'Желания',
          'type': 'Появление',
          'cardID': 'Идентификатор карты',
          'status': 'Cтатус',
          'active': 'Активный',
          'requestDate': 'Год спроса',
          'requestBy': 'Запросить',
          'notActive': 'Не активен',
          'activateCard': 'Добавить активную карту',
          'requestCard': 'Запрос карты',
          'createNewUser': 'Создать нового пользователя',
          'makePayment': 'Производить оплату',
          'filterStations': 'Станции фильтрации',
          'favorites': 'Избранное',
          'public': 'Открыт для всех',
          'limited': 'Ограниченное использование',
          'onlyCV': 'Только Cv зарядные станции',
          'cFee': 'Почасовая оплата',
          'bFee': 'Заблокировать платеж',
          'oFee': 'Занять плату',
          'direction': 'Адрес',
          'sunday': 'Воскресенье',
          'monday': 'Понедельник',
          ...
          'friday': 'Пятница',
          'saturday': 'Суббота',
          'atoUse': 'Доступно для использования',
          'reserve': 'Сдержанный',
          'mInfo': 'Больше информации',
          'operator': 'Оператор',
          'location': 'Адрес',
          'addtoFav': 'Добавить избранное',
          'setAsHome': 'Сделать домашней станцией',
          'setAsWork': 'Обозначается как рабочая станция',
          'uType': 'Тип использования',
          'address': 'Aдрес',
          'sHours': 'Часы работы',
          ...
          'edit': 'Редактировать',
          'delete': 'Удалить',
          'addStation': 'Добавлять',
        },
        'en': {
          'text1': 'Welcome',
          'text2': 'Complete and correct user information',
          'text3': 'Gmail',
          'text4': 'Password',
          'text5': 'Login',
          'text6': 'Sign in',
          ...
          'error2': 'Incorrect',
          'error4': 'You dont have any electric charges available right now',
          'error5': 'You cannot make a booking at this time',
          'error3': 'Wrong password',
          'startCharge2': 'Give electric charge',
          'stationsClosest': 'Nearest stations',
          ...
          'sendOtp': 'Send confirmation code',
          'changePhoneNumber': 'change phone number',
          'changePassword': 'Change password',
          'passivateContract': 'PassiveContract',
          'deleteContract': 'Delete contract',
          'contractType': 'Type of contract',
          'personal': 'Personal',
          'contractCode': 'contract code',
          'contactUsSubtitle': 'You can contact us using the following \n information:',
          'withQRCode': 'with QR code',
          'or': 'or',
          'ongoingCharges': 'Continuous electrical charges',
          'enterStationCode': 'enter station code',
          'enterCode': 'enter code',
          'startCharge': 'started',
          'startChargeSub': 'Your car has started charging',
          'requests': 'wishes',
          'type': 'Appearance',
          'cardID': 'CardID',
          'status': 'Status',
          'active': 'Active',
          'requestDate': 'Year of demand',
          'requestBy': 'Request',
          'notActive': 'Not active',
          'activateCard': 'Add active card',
          ...
          'public': 'Open to all',
          'limited': 'Limited use',
          'onlyCV': 'Only Cv charging stations',
          'cFee': 'Hourly charge',
          'bFee': 'Block payment',
          'oFee': 'Borrow payment',
          'direction': 'Address',
          ...
          'friday': 'Friday',
          'saturday': 'Saturday',
          'atoUse': 'Available for use',
          'reserve': 'reserved',
          'mInfo': 'More information',
          'operator': 'Operator',
          'location': 'Address',
          'addtoFav': 'Add Favorites',
          'setAsHome': 'Make a home station',
          'setAsWork': 'Designated as work station',
          'uType': 'Type of use',
          'address': 'Address',
          'sHours': 'Working hours',
